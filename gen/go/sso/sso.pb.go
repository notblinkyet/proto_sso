...
type RegisterRequest struct {
	...
	Login    string `protobuf:"bytes,1,opt,name=login,proto3" json:"login,omitempty"`       // login of the user to be registered.
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // password of the user to be registered.
}
...
type LoginRequest struct {
	...
	Login    string `protobuf:"bytes,1,opt,name=login,proto3" json:"login,omitempty"`               // Login of the user to be registered.
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         // Password of the user to be registered.
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // ID of the app user was registered.
}
...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Auth token of the user to be registered.
}
...
type IsAdminRequest struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // Auth token of the user to be checked.
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x1a, 0x5a, 0x18, 0x73, 0x73, 0x6f, 0x5f, 0x70, 0x72,
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73, 0x6f,
